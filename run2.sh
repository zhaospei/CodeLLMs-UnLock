...
# python3 -m pipeline.save_hidden_states2 --model deepseek-ai/deepseek-coder-1.3b-instruct --dataset human_eval --num_generations_per_prompt 10  --project_ind 0 --layer 0 1 4 8 12 16 20 24 --max_new_tokens 512 --language python --max_num_gen_once 5
