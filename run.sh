...
python3 -m pipeline.save_hidden_states2 --model deepseek-ai/deepseek-coder-6.7b-instruct --dataset human_eval --num_generations_per_prompt 10  --project_ind 0 --layer 0 1 4 8 12 16 20 24 28 32 --max_new_tokens 512 --language python --max_num_gen_once 5
python3 -m pipeline.save_hidden_states2 --model codellama/CodeLlama-7b-Instruct-hf --dataset human_eval --num_generations_per_prompt 10  --project_ind 0 --layer 0 1 4 8 12 16 20 24 28 32 --max_new_tokens 512 --language python --max_num_gen_once 5
python3 -m pipeline.save_hidden_states2 --model ise-uiuc/Magicoder-S-DS-6.7B --dataset human_eval --num_generations_per_prompt 10  --project_ind 0 --layer 0 1 4 8 12 16 20 24 28 32 --max_new_tokens 512 --language python --max_num_gen_once 5
