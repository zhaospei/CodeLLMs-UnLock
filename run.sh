...
# 0 1 2 15 16 17 30 31 32
python3 -m pipeline.save_hidden_states --model codellama/CodeLlama-13b-Instruct-hf --dataset dev_eval --num_generations_per_prompt 10 --fraction_of_data_to_use 1 --project_ind 0 --layer 40 --max_new_tokens 512 --max_num_gen_once 5
