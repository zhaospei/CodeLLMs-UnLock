...
# 0 1 2 15 16 17 30 31 32
python3 -m pipeline.save_hidden_states --model openai/gpt-oss-20b --dataset dev_eval --num_generations_per_prompt 10 --fraction_of_data_to_use 1 --project_ind 0 --layer 1 4 8 12 16 20 24 --max_new_tokens 512 --max_num_gen_once 5 --part_id 0 --num_parts 5
...
#python3 -m pipeline.save_all_internal_states --model deepseek-ai/deepseek-coder-6.7b-instruct --dataset dev_eval --num_genedev_evalons_per_prompt 10 --fraction_of_data_to_use 1 --project_ind 0 --layer 1 4 8 12 16 20 24 28 32 --max_new_tokens 512 --language python --max_num_gen_once 4



# python3 -m pipeline.save_all_internal_states --model deepseek-ai/deepseek-coder-1.3b-instruct --dataset dev_eval --num_genedev_evalons_per_prompt 10 --fraction_of_data_to_use 1 --project_ind 0 --layer 1 4 8 12 16 20 24 28 32 --max_new_tokens 512 --language python --max_num_gen_once 2
